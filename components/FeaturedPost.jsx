    ...
    return (
        <div id='featuredBody' className=' relative h-96 w-full'>
            ...
            <section className='relative p-10 flex flex-col justify-center h-full z-10 text-white lg:w-2/3 gap-5'>
                <p className='intern-text-p1'>POSTED ON <a href={`/categories/${featuredPost[0].categories[0].slug}`} className='text-yellow-300 uppercase'>{featuredPost[0].categories[0].name}</a></p>
