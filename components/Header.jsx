...
const Header = () => {
  return (
    <div class="navbar bg-[#232536] text-white lg:px-10">
      <div class="navbar-start">
        <div class="dropdown">
          <div tabindex="0" role="button" class="btn btn-ghost btn-circle">
            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 6h16M4 12h16M4 18h7" /></svg>
          </div>
          <ul tabindex="0" class="menu menu-md dropdown-content mt-3 p-2 shadow bg-base-100 rounded-box w-52 z-40 text-black">
      ...
      <div class="navbar-center">
        <Link class="btn btn-ghost text-xl" href={'/'}>InternInsights</Link>
      </div>
      <div class="navbar-end">
      <label className="swap swap-rotate">
        {/* this hidden checkbox controls the state */}
        <input type="checkbox" label='dark/light mode toggle'/>
