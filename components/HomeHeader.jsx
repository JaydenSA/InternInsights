...
const HomeHeader = () => {
	...
	return (
		<div className="flex flex-col justify-center items-center bg-white">
			...
			<ul className='hidden md:flex justify-center bg-yellow-500 text-white pb-5 md:pt-5 gap-10 w-full font-bold uppercase'>
			...
			<div className="md:hidden flex flex-1 w-full flex-col justify-center items-center py-3">
				<img
				...
				>
				<ul className="list-none flex justify-center uppercase items-center flex-1 flex-col gap-5 text-black">
